# -*- coding: utf-8 -*-
"""
Created on Mon Oct 30 15:17:00 2017
...
#!ALERT! - the text files for Authors A + B will need to be in the same folder as this program for the files to be detected and processed
...
#print(new_listA)    #had this placed through the program to allow for some sanity checking as a went through. ensuring all work was carrying forward correctly. Uncomment this to obtain the full list of N-Grams
...
#i took this approach as it keeps things simple as well as being able to change the length of the split. I did look to try and make this a function to process n but was not successful.
...
#variable created that took all the above and allowed to again call upon the sorted dictionary.
...
def top_20_nGramA(file, n, order = True): #Went with a function here as i wanted to be able to pass through "n", rather than including a specific integer that cannot be changed. Setting Order as true gave it a top20 from top to bottom rather than random
...
#Bringing the 2 sets of top 20 dictionaries and printing them, then passing them on to calculate the mean + Std Dev

print("")  #included these to help seperate the individual prints in the console, for ease of reading
print("Author A top 20 N-Grams:\n", AuthA_final)
print("")
print("Author B top 20 N-Grams:\n", AuthB_final)
print("")  
...
#Mean for Author A
print("The mean of the top 20 N-Grams for Author A is:\n", (npy.mean(t20_list_A)))
print("")
#Standard deviation of Author A
print("The standard deviation of the top 20 N-Grams for Author A is:\n", (npy.std(t20_list_A)))
print("")
#Repeated for Author B
t20_list_B = list(AuthB_final.values())
print("The mean of the top 20 N-Grams for Author B is:\n", (npy.mean(t20_list_B)))
print("")
print("The standard deviation of the top 20 N-Grams for Author B is:\n", (npy.std(t20_list_B)))
print("")
...
#Reflection on the design + things i would like to have changed/ worked
#I would have liked to have had a program that you can input your own text and then goes through the file rather than having a duplicate to run 2 individual texts.
#As this doesn't contrain memory too much for the size of the program it wasn't as much of an issue, but am aware that if i wanted this to be run on a greater amount of text files,
#a more efficient and concise program would need to be implemented from the above.
